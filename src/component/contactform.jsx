  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-start gap-8 mt-24 text-xl align-text-bottom ">
          <img src="Vector.png" alt="" className="w-8 h-9" />{" "}
          <p>+123 456 7890</p>
        </div>
        <div className="flex items-start gap-8 mt-16 text-xl align-text-bottom ">
          <img src="/inbox-icon.png" alt="" className="w-6 h-5 " />
          <p>demo@gmail.com</p>
        </div>
        <div className="flex items-start gap-8 mt-16 mb-48 text-xl align-text-bottom ">
